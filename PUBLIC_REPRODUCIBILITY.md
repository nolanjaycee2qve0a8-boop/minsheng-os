...
公共基线为 v0.33，公共 CI 使用 Node.js 22 与 Python 3.11，并只运行离线、确定性的公共测试。`node tools/run_public_ci.js` 会验证公共边界、fixture 隔离、selector population、Python 用例、语法、compile 与 clean export。
...
仓库当前没有开源许可证。公共测试可复现软件边界，不替代原始资料核验，也不授权第三方内容再分发。
